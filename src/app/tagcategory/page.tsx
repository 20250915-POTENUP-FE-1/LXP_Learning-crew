...
import { useTabs, useTagSearch } from "./hooks/useFormData";
...
export default function TagCategoryPage() {
  ...
  return (
    <div className="flex w-full justify-center py-16">
      <div className="flex w-[782px] flex-col items-center">
        <h1 className="mb-2 text-2xl font-bold text-gray-900">
          관심 태그 설정
        </h1>
        <p className="mb-[72px] text-base text-gray-500">
        ...
        <div className="w-full">
          ...
          <div className="flex min-h-[38px] flex-row flex-wrap gap-2 pb-[101px]">
          ...
          <form className="mb-7 flex justify-center">
          ...
          <div className="mb-10 min-h-[300px]">
            {displayGroups.map((group) => (
              <div key={group.title} className="mb-[138px]">
          ...
          <div className="ml-[131px] flex h-11 w-[520px] justify-center">
            <ActionButton
              size="medium"
              value="관심 태그 저장"
              variant="primary"
